...
class Blog extends Factory {
  ...
  /**
   * The create() method allows for pre- and post- callbacks around object creation.
  ...
  /**
   * The build() method should return the $default array as it is after being
   ...
   * callbacks within the create() method above.  This method should actually do
