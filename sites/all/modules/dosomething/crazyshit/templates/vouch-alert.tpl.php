...
<p class="connect-with-facebook"><a href="https://www.facebook.com/dialog/oauth?client_id=<?php echo variable_get('fboauth_id'); ?>&redirect_uri=http://<?php echo CRAZY_DOMAIN; ?>/crazy/friends&scope=email,user_birthday">Connect with Facebook</a></p>