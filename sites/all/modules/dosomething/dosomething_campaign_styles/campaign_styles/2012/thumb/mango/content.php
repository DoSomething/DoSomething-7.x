...
<div id="cork">
  ...
  <div class="header">
    ...
    <a href="https://twitter.com/share?url=http%3A%2F%2Fwww.thumbwars.org&text=Save your friends from the dangers of texting and driving with @DoSomething's %23ThumbWars:" class="social-t" target="_blank"></a>
      ...
      <h2>
        <span>But now, you can save your friends with</span><br><span>the power of your thumbs.</span>
      </h2>
  </div> <!-- .header -->
...
<div id="cask">
  ...
  <div class="section learn">
    ...
    <div class="col2">
      <iframe frameborder="0" width="480" height="270" src="http://www.youtube.com/embed/QtzTi2T6LJk?version=3&rel=0&controls=0&showinfo=0"></iframe>
    </div> <!-- .col2 -->
  ...
  <div class="section scholarship" id="scholarships">
    ...
    <img src="http://files.dosomething.org/files/campaigns/thumb/scroll/scholarship1.png" alt="two ways to enter"/>
