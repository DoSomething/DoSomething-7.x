(function ($) {
  Drupal.behaviors.campaignName = {
    attach: function (context, settings) {
        ...
        // add status button
        $('#webform-client-form-728012 > div > #edit-actions').append('<p class="status-btn go-button"><a href="//www.dosomething.org/footlocker/associate/status/">Status Page</a></p>');
    }
  };
})(jQuery);
