                      ...
                      <tbody>
                        <tr>
                          <td align="left" id="main">
                            ...
                            <p style="margin: 13px 0 13px 5px;padding: 0;font-size: 13px;font-family: Arial, sans-serif;width: 100%">
                              Here are some immediate next steps:</p>
                            <ol>
                              <li style="margin: 13px 0px 13px 5px; padding: 0px; font-size: 13px; font-family: Arial, sans-serif; width: 100%; ">
                                <a href="http://www.dosomething.org/clubs/starter-kit">Check out</a> our online starter-kit for a quick tutorial on how to get your club off the ground.</li>
                              <li style="margin: 13px 0px 13px 5px; padding: 0px; font-size: 13px; font-family: Arial, sans-serif; width: 100%; ">
                                <a href="http://www.dosomething.org/campaigns">Take a look</a>&nbsp;at our easy project ideas you can get involved in.</li>
                              <li style="margin: 13px 0px 13px 5px; padding: 0px; font-size: 13px; font-family: Arial, sans-serif; width: 100%; ">
                                Give all of our <a href="http://www.dosomething.org/clubs/resources">clubs resources</a> a glance for a thorough walk-through to take your Do Something Club to the next level.</li>
                            </ol>
                            <p style="margin: 13px 0px 13px 5px; padding: 0px; font-size: 13px; font-family: Arial, sans-serif; width: 100%; ">
                              If you have any questions, email us at clubs@dosomething.org - We&#39;re here to help!</p>
                            <p style="margin: 13px 0px 13px 5px; padding: 0px; font-size: 13px; font-family: Arial, sans-serif; width: 100%; ">
                              -- Thanks<br />
                              The DoSomething.org Clubs Team</p>
                            <p style="margin: 13px 0px 13px 5px; padding: 0px; font-size: 13px; font-family: Arial, sans-serif; width: 100%; ">
