...
<br /><br />If you could be the coolest parent/guardian and click the following link, then <?php print $full_name ?> can be a part of our online community: <?php print $link; ?>
