<?php
  ...
  $scholarship = array(
    ...
    2 => "Great! You're gonna do this with a group. Here's what you need to do to qualify for the scholarship. Before you get started <a href=\" . $files_source . 'action-guide.pdf'\">download</a> your PB&J Kit.",
  );
