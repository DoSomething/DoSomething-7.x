(function ($) {
  Drupal.behaviors.campaignName = {
    ...
    var reg_leftcol = '<div id="reg_leftcol"><h1>This campaign is complete</h1><h2>Sign up to see the results of the efforts of over 50,000 DoSomething.org members feeding the hungry in their community.</h2></div>'
