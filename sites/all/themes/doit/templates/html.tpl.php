...
<head profile="<?php print $grddl_profile; ?>">
  ...
  @font-face {
    ...
    font-weight: 400;
    src: url('/sites/all/libraries/ds-neue/assets/fonts/proxima-nova/ProximaNova-Reg-webfont.eot');
    src: url('/sites/all/libraries/ds-neue/assets/fonts/proxima-nova/ProximaNova-Reg-webfont.eot?') format('eot'),
      url('/sites/all/libraries/ds-neue/assets/fonts/proxima-nova/ProximaNova-Reg-webfont.woff') format('woff');
  }
