<section class="header" id="header">
  ...
  <?php if ($project_logo_uri): ?>
    <img class="header-logo" src="<?php print $project_logo_uri; ?>" alt="<?php print $project_logo_alt; ?>" />
  <?php endif; ?>
